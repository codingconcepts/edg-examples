...
edg up \
--driver pgx \
--config examples/sysbench_read_write/crdb.edg \
...
edg up \
--driver mysql \
--config examples/sysbench_read_write/mysql.edg \
...
edg up \
--driver oracle \
--config examples/sysbench_read_write/oracle.edg \
...
edg up \
--driver mssql \
--config examples/sysbench_read_write/mssql.edg \
...
edg up \
--driver cassandra \
--config examples/sysbench_read_write/cassandra.edg \
--url "localhost:9042"
...
edg up \
--driver mongodb \
--config examples/sysbench_read_write/mongodb.edg \

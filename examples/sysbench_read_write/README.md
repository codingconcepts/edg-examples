...
edg up \
--driver pgx \
--config examples/sysbench_read_write/crdb.yaml \
...
edg up \
--driver mysql \
--config examples/sysbench_read_write/mysql.yaml \
...
edg up \
--driver oracle \
--config examples/sysbench_read_write/oracle.yaml \
...
edg up \
--driver mssql \
--config examples/sysbench_read_write/mssql.yaml \
...
edg up \
--driver cassandra \
--config examples/sysbench_read_write/cassandra.yaml \
--url "localhost:9042"
...
edg up \
--driver mongodb \
--config examples/sysbench_read_write/mongodb.yaml \
...
edg up \
--driver spanner \
--config examples/sysbench_read_write/spanner.yaml \

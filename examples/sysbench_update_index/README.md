...
edg up \
--driver pgx \
--config examples/sysbench_update_index/crdb.edg \
...
edg up \
--driver mysql \
--config examples/sysbench_update_index/mysql.edg \
...
edg up \
--driver oracle \
--config examples/sysbench_update_index/oracle.edg \
...
edg up \
--driver mssql \
--config examples/sysbench_update_index/mssql.edg \
...
edg up \
--driver cassandra \
--config examples/sysbench_update_index/cassandra.edg \
--url "localhost:9042"
...
edg up \
--driver mongodb \
--config examples/sysbench_update_index/mongodb.edg \

...
edg up \
--driver pgx \
--config examples/tatp/crdb.yaml \
...
edg up \
--driver mysql \
--config examples/tatp/mysql.yaml \
...
edg up \
--driver oracle \
--config examples/tatp/oracle.yaml \
...
edg up \
--driver mssql \
--config examples/tatp/mssql.yaml \
...
edg up \
--driver cassandra \
--config examples/tatp/cassandra.yaml \
--url "localhost:9042"
...
edg up \
--driver mongodb \
--config examples/tatp/mongodb.yaml \
...
edg up \
--driver spanner \
--config examples/tatp/spanner.yaml \

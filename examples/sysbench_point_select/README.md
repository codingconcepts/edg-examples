...
edg up \
--driver pgx \
--config examples/sysbench_point_select/crdb.edg \
...
edg up \
--driver mysql \
--config examples/sysbench_point_select/mysql.edg \
...
edg up \
--driver oracle \
--config examples/sysbench_point_select/oracle.edg \
...
edg up \
--driver mssql \
--config examples/sysbench_point_select/mssql.edg \
...
edg up \
--driver cassandra \
--config examples/sysbench_point_select/cassandra.edg \
--url "localhost:9042"
...
edg up \
--driver mongodb \
--config examples/sysbench_point_select/mongodb.edg \
...
edg up \
--driver spanner \
--config examples/sysbench_point_select/spanner.edg \

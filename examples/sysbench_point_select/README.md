...
edg up \
--driver pgx \
--config examples/sysbench_point_select/crdb.yaml \
...
edg up \
--driver mysql \
--config examples/sysbench_point_select/mysql.yaml \
...
edg up \
--driver oracle \
--config examples/sysbench_point_select/oracle.yaml \
...
edg up \
--driver mssql \
--config examples/sysbench_point_select/mssql.yaml \
...
edg up \
--driver cassandra \
--config examples/sysbench_point_select/cassandra.yaml \
--url "localhost:9042"
...
edg up \
--driver mongodb \
--config examples/sysbench_point_select/mongodb.yaml \
...
edg up \
--driver spanner \
--config examples/sysbench_point_select/spanner.yaml \
